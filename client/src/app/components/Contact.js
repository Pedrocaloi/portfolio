    ...
    <div name='contact' className='w-full h-screen bg-gradient-to-b from-black to bg-gray-800 p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action='https://getform.io/f/95323f16-ff69-43b3-a283-2650cc462006' method='POST' className=' flex flex-col w-full md:w-1/2'>
                    ...
                    <button className='text-white bg-gradient-to-r from-violet-900 to-orange-700 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>Let's talk</button>
                </form>
            </div>
        </div>
    </div>
